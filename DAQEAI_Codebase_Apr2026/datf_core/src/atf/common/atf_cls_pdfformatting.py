...
class generatePDF:
  ...
  def __init__(self,work_path=''):
    ...
    self.pdf.add_page()
    self.pdf.add_font('DejaVu', '', f"{root_path}src/atf/common/DejaVuSans.ttf", uni=True)
    self.pdf.add_font('DejaVu', 'B', f"{root_path}src/atf/common/DejaVuSans-Bold.ttf", uni=True)
    self.pdf.add_font('DejaVu', 'I', f"{root_path}src/atf/common/DejaVuSans-Oblique.ttf", uni=True)
    self.pdf.add_font('DejaVu', 'BI', f"{root_path}src/atf/common/DejaVuSans-BoldOblique.ttf", uni=True)
  ...
  def write_text(self, text, texttype):
    ...
    if texttype == 'report header':
      ...
      self.pdf.set_font('DejaVu','B',15.0) 
      self.pdf.cell(self.epw, 0.0, text, align='C')
      self.pdf.ln(7)
      
    elif texttype == 'subheading':
      self.pdf.set_font('DejaVu','B',12.0) 
      self.pdf.cell(self.epw, 0.0, text, align = 'C')
      self.pdf.set_font('DejaVu','',12.0)
      self.pdf.ln(5)
      ...
      self.pdf.cell(self.epw, 0.0, text)
        ...
        self.pdf.ln(6)
        self.pdf.set_font('DejaVu', 'B', 11.0)
        self.pdf.cell(self.epw, 0.0, text)
        self.pdf.set_font('DejaVu', '', 11.0)
  ...
  def create_table_schemacomp(self, df, col_width_list, table_type=''):
      self.pdf.ln(5)
      self.pdf.set_font('DejaVu','B',10.0) 
      th = self.pdf.font_size
      if(df is None):
        self.pdf.set_font('DejaVu','',10.0)
      ...
      self.pdf.set_font('DejaVu','',10.0) #Sid : Changed font from 11 to 10
      th = self.pdf.font_size
