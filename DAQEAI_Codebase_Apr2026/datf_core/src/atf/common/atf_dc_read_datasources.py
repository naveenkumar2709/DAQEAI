...
from atf.common.atf_dc_read_teradata import read_teradata
...
def read_data(tc_datasource_config,spark):
  ...
  elif connectiontype == 'teradata' and resourceformat == 'table':
    df, query = read_teradata(tc_datasource_config, spark)
